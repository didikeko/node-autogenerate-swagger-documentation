...
const swaggerOptions = {
    swaggerDefinition: {
      info: {
        version: "1.0",
        title: "INPOINT API",
        description: "Telkom INPOINT API",
        contact: {
          name: "deni@gmail.com"
        },
        servers: ["http://localhost:5000/api-inpoint"]
      }
    },
    // ['.routes/*.js']
    definitions: {},
    apis: ["./bin/swaggerlist/api-inpoint.js"]
  };
// Routes
/**
 * @swagger
	 * /api-inpoint/customers:
 *  post:
 ...
 *        description: OK
 */
app.post("/api-inpoint/customers", (req, res) => {
  res.status(200).json({
      success: true,
 ...
 *        description: OK
 */
app.get("/api-inpoint/customers", (req, res) => {
  res.status(200).json({
      success: true,
      data: customers,
 ...
 *  - BasicAuth: []
 */
app.put("/api-inpoint/customers/:id", (req, res) => {
  res.status(200).json({
    success: true,
    data: { 
        id: req.params.id,
