...
const swaggerOptions = {
    swaggerDefinition: {
      info: {
        version: "1.0",
        title: "TELKOMDDS API",
        description: "Telkom DDS API",
        contact: {
          name: "difa@gmail.com"
        },
        servers: ["http://localhost:5000/api-telkomdds"]
      }
    },
    // ['.routes/*.js']
    definitions: {},
    apis: ["./bin/swaggerlist/api-telkomdds.js"]
  };
// Routes
/**
 * @swagger
	 * /api-telkomdds/customers:
 *  post:
 ...
 *        description: OK
 */
app.post("/api-telkomdds/customers", (req, res) => {
  res.status(200).json({
      success: true,
 ...
 *        description: OK
 */
app.get("/api-telkomdds/customers", (req, res) => {
  res.status(200).json({
      success: true,
      data: customers,
 ...
 *  - BasicAuth: []
 */
app.put("/api-telkomdds/customers/:id", (req, res) => {
  res.status(200).json({
    success: true,
    data: { 
        id: req.params.id,
