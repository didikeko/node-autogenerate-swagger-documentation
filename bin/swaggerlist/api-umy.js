...
const swaggerOptions = {
    swaggerDefinition: {
      info: {
        ...
        servers: ["http://localhost:5000/api-umy"]
      }
    },
    // ['.routes/*.js']
    definitions: {},
    apis: ["./bin/swaggerlist/api-umy.js"]
  };
// Routes
/**
 * @swagger
 ...
 *        description: OK
 */
app.post("/api-umy/customers", (req, res) => {
  res.status(200).json({
      success: true,
 ...
 *        description: OK
 */
app.get("/api-umy/customers", (req, res) => {
  res.status(200).json({
      success: true,
      data: customers,
 ...
 *  - BasicAuth: []
 */
app.put("/api-umy/customers/:id", (req, res) => {
  res.status(200).json({
    success: true,
    data: { 
        id: req.params.id,
